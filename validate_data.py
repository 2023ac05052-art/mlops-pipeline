...
def validate_data(df: pd.DataFrame):
    ...
    Returns:
        list: Validation errors, or empty if the data is valid.
    """
    try:
...
if __name__ == "__main__":
    try:
        ...
        print(
            "Error: 'data/breast_cancer.csv' not found. Please ensure "
            "the file exists."
        )
        exit(1)
